...
### 1. Nhóm Dữ liệu (Data Team) - 3 Thành viên: [Tên_A], [Tên_B], [Tên_C]
...
### 2. Nhóm Mô hình và Thuật toán (Model Team) - 1 Thành viên: [Tên_D]
...
### 3. Nhóm Huấn luyện và Đánh giá (Training Team) - 1 Thành viên: [Tên_E]
...
### 4. Nhóm Giao diện và Tích hợp (UI/Integration Team) - 1 Thành viên: [Tên_F]
...
### Giao thức 1: Định dạng dữ liệu đầu vào (Từ Nhóm Dữ liệu tới Nhóm Huấn luyện)
...
### Giao thức 2: Tích hợp mô hình (Từ Nhóm Huấn luyện tới Nhóm Giao diện)
